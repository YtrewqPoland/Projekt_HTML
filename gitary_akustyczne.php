...
<body>
    <header class="menu">
        ...
        <?php
            ...
            try{
                $stmt = $pdo->query("SELECT * FROM gitary WHERE type=2 ORDER BY {$orderBy}");
        ...
        <div class="sort-controls">
            ...
            <a href="gitary_akustyczne.php?sort=price_asc"<?= $sort === 'price_asc' ? ' class="active"' : '' ?>>Rosnąco</a>
            <a href="gitary_akustyczne.php?sort=price_desc"<?= $sort === 'price_desc' ? ' class="active"' : '' ?>>Malejąco</a>
        </div>
        <div class="produkty">
